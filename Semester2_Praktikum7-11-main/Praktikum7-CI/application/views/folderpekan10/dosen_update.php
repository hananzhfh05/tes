    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Form Update Dosen</h3>
        ...
        ?>
        <?php echo form_open('tambahdosen/save', '', $hidden);?>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <input id="nidn" name="nidn" value="<?=$dsnedit->nidn?>" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
